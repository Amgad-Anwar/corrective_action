                            ...
                            <a class="dropdown-item" href="javascript:;">
                                <div class="media align-items-center">
                                    <div class="user-online">
                                        <img src="{{ asset('images/110x110.png') }}" class="msg-avatar" alt="user avatar">
                                    </div>
                ...
                <li class="nav-item dropdown dropdown-language">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;" data-toggle="dropdown">
                        <div class="lang d-flex">
                            <div><i class="flag-icon flag-icon-{{ config('laravellocalization.supportedLocales.'.LaravelLocalization::getCurrentLocale())['flag'] }}"></i>
                            </div>
                            <div><span>{{ LaravelLocalization::getCurrentLocale() }}</span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
