...
use App\Http\Controllers\Api\SubscriptionTransactionsController;
...
Route::group([
    ...
    Route::group([
        ...
        Route::post('/store/subscription', [SubscriptionTransactionsController::class, 'storeSubscriptionTrans']);  
